...
export const projects: Project[] = [
    ...
    },
    {
        ...
        name: "wplacer",
        type: "Automation",
        description: "Auto-drawing bot for wplace.live.",
        longDescription: "An automated script for drawing pixel art on the wplace.live canvas.",
        approach: "JavaScript-based automation for accurate pixel placement.",
        outcome: "Maintained artwork integrity automatically.",
        techStack: ["JavaScript", "Automation"],
        tags: ["Bot", "Canvas", "Scripting"],
        sourceUrl: "https://github.com/luinbytes/wplacer",
        featured: false,
    },
    {
        id: "bongocat",
